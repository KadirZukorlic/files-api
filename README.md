...
2. Run `npm install`
3. Run `npm start`
4. When server starts send a GET request to `http://localhost:3000/api/files` in postman or whatever you like to use
